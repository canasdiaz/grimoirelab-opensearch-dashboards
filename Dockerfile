...
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/radar-vis-plugin/releases/download/0.40.0/radar-vis-plugin-0.40.0_3.7.0.zip
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/network-vis-plugin/releases/download/0.40.0/network-vis-plugin-0.40.0_3.7.0.zip
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/dotplot-vis-plugin/releases/download/0.40.0/dotplot-vis-plugin-0.40.0_3.7.0.zip
